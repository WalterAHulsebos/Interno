...
public static class DebugExtension
{
	...
	/// </param>
	public static void DebugPoint(this Debug debug, Vector3 position, Color color, float scale = 1.0f, float duration = 0, bool depthTest = true)
	{
	...
	/// 	- Whether or not this point should be faded when behind other objects.
	/// </param>
	public static void DebugPoint(this Debug debug, Vector3 position, float scale = 1.0f, float duration = 0, bool depthTest = true)
	{
		DebugPoint(debug, position, Color.white, scale, duration, depthTest);
	}
